...
This section gets **rewritten** when focus changes, not appended to.

### 8. Source Transcripts
Two parts:
...
2. Drop Suggested Work items that are stale or irrelevant
...
6. Never trim The Idea, Resuming, or What We Want To Do — these are always critical
